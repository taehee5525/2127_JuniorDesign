...
public class Util {
    ...
    public static final String ILP_ADDRESS_PREFIX = "g.us.techpayfsp";
    ...
    public static final Map<String, EndPointStringMaker> endPointMap = new HashMap<>() {
        {
            put("FSPIOP_CALLBACK_URL_PARTIES_PUT_ERROR", new EndPointStringMaker("http://10.5.0.4:", "/parties/{{partyIdType}}/{{partyIdentifier}}/error"));
            put("FSPIOP_CALLBACK_URL_PARTIES_PUT", new EndPointStringMaker("http://10.5.0.4:", "/parties/{{partyIdType}}/{{partyIdentifier}}"));
            put("FSPIOP_CALLBACK_URL_PARTICIPANT_PUT_ERROR", new EndPointStringMaker("http://10.5.0.4:", "/participants/{{partyIdType}}/{{partyIdentifier}}/error"));
            put("FSPIOP_CALLBACK_URL_PARTICIPANT_PUT", new EndPointStringMaker("http://10.5.0.4:", "/participants/{{partyIdType}}/{{partyIdentifier}}"));
            put("FSPIOP_CALLBACK_URL_PARTIES_SUB_ID_GET", new EndPointStringMaker("http://10.5.0.4:", "/parties/{{partyIdType}}/{{partyIdentifier}}"));
            put("FSPIOP_CALLBACK_URL_PARTIES_SUB_ID_PUT", new EndPointStringMaker("http://10.5.0.4:", "/parties/{{partyIdType}}/{{partyIdentifier}}/{{partySubIdOrType}}"));
        }
    };
